...
LANGUAGES = [
    ...
    {
        'name': 'English',
        'common_words': ['I', 'him', 'us', 'to', 'her', 'them', 'is', 'it', 'and',
                    'the', 'what', 'we', 'to', 'a', 'he', 'in', 'it',
                    'with', 'yes', 'like', 'to', 'on', 'me', 'that', 'so',
                    'here', 'when', 'has', 'all', 'are', 'of',
                    'you', 'war', 'who', 'for', 'to', 'da',
                    'am', 'more', 'you', 'us', 'only', 'can', 'the '
        ]
    },
    {
        'name': 'German',
